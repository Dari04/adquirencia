...
export const CAREER_POSTS_DIRECTORY = '_data/blog-posts/career-with-locales';
export const ELEARNING_POSTS_DIRECTORY = '_data/blog-posts/e-learning-with-locales';
