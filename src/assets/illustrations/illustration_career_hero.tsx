...
// icons
import accountingIcon from '../../../public/static/icons/ic_accounting.svg';
import healthCareIcon from '../../../public/static/icons/ic_health_care.svg';
import bankingCurrencyIcon from '../../../public/static/icons/ic_banking_currency.svg';
import softwareDevelopmentIcon from '../../../public/static/icons/ic_software_development.svg';
    ...
    >
      <>
        ...
        >
          <m.div style={{ y: offsetY(-50) }}>
            <Label
              text="Accounting"
              icon={<Image alt="accounting" src={accountingIcon} sx={{ width: 48, height: 48 }} />}
            />
          </m.div>
        </Box>
      ...
      <Box sx={{ position: 'absolute', transform: 'translate(175px, 90px) rotate(15deg)' }}>
        <m.div style={{ x: offsetX(80), y: offsetY(80) }}>
          <Label
            text="Banking"
            icon={<Image alt="banking" src={bankingCurrencyIcon} sx={{ width: 48, height: 48 }} />}
          />
        </m.div>
      </Box>
      ...
      <Box sx={{ position: 'absolute', transform: 'translate(170px, -110px) rotate(15deg)' }}>
        <m.div style={{ y: offsetY(80) }}>
          <Label
            text="Health Care"
            icon={<Image alt="health care" src={healthCareIcon} sx={{ width: 48, height: 48 }} />}
          />
        </m.div>
      </Box>
