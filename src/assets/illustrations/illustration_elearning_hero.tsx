...
// icons
import bookIcon from '../../../public/static/icons/ic_book.png';
import pencilIcon from '../../../public/static/icons/ic_pencil.png';
import pythonIcon from '../../../public/static/icons/platform/ic_platform_python.svg';
import teacherImg from '../../../public/static/images/course/course_teacher_hero.png';
  ...
  return (
    <RootStyle {...other}>
      <Box sx={{ position: 'absolute', right: 18, bottom: 28, zIndex: 8 }}>
        <Image alt="teacher" src={teacherImg} placeholder="blur" sx={{ width: 546, height: 650 }} />
      </Box>
      ...
      >
        <Image alt="book icon" src={bookIcon} sx={{ width: 52, height: 62 }} />
      </Box>
      ...
      >
        <Image alt="pencil icon" src={pencilIcon} sx={{ width: 60, height: 77 }} />
      </Box>
      ...
      >
        <Label
          text="Python"
          icon={<Image alt="python" src={pythonIcon} sx={{ width: 56, height: 56 }} />}
          sx={{
            py: 1.75,
            typography: 'h3',
            color: '#2994FF',
