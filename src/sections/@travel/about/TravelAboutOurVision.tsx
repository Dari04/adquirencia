...
// images
import visionIllustration from '../../../../public/static/illustrations/illustration_vision.svg';
      ...
      <Container>
        ...
        >
          <Grid item xs={12} md={6} lg={5}>
            <Image alt="vision" src={visionIllustration} layout="intrinsic" placeholder="blur" />
          </Grid>
