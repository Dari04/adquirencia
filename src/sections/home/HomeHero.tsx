...
// hooks
import { useLocales, useBoundingClientRect } from '../../hooks';
// routes
import Routes from '../../routes';
// components
import { Image, Iconify } from '../../components';
// images
import homeHeroImg from '../../../public/static/images/home/home_hero.png';
...
export default function HomeHero() {
  ...
  return (
    <RootStyle>
              ...
              <Stack direction="row" spacing={2.5}>
                {['figma', 'javascript', 'typescript', 'material', 'react'].map((icon) => (
                  <Image
                    key={icon}
                    alt={icon}
                    src={`/static/icons/platform/ic_platform_${icon}.svg`}
      ...
      >
        <Image alt="home-hero" src={homeHeroImg} layout="intrinsic" placeholder="blur" />
      </Box>
    </RootStyle>
  );
}
