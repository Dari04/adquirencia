...
// images
import teamsIllustration from '../../../../public/static/illustrations/illustration_teams.svg';
    ...
    <RootStyle>
      <Container>
        <Grid container spacing={3} justifyContent="space-between" alignItems="center">
          ...
          >
            <Image alt="teams" src={teamsIllustration} layout="intrinsic" placeholder="blur" />
          </Grid>
